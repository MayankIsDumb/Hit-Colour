                ...
                .category(ConfigCategory.createBuilder()
                        ...
                        .group(OptionGroup.createBuilder()
                                ...
                                .option(Option.createBuilder(int.class)
                                        ...
                                        // Custom slider: YACL's built-in one hardcodes GLFW left button (0) and
                                        // ignores clicks on 26.3's SDL backend (left = 1), see SdlSafeIntegerSlider.
                                        .customController(opt -> new SdlSafeIntegerSlider(opt, 0, 100, 5, val -> Component.literal(val + "%")))
                                        .build())
                                .build())
                        .build())
